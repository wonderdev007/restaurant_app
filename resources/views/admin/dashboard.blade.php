                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="metric-value d-inline-block">
                        <h1 class="mb-1">&pound;{{$estimated_income_last_30}}</h1>
                      </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="metric-value d-inline-block">
                        <h1 class="mb-1">&pound;{{$total_customers_last_30}}</h1>
                      </div>
                      <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                        <span>
                          <i class="fa fa-fw fa-arrow-up"></i>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                      <h5 class="card-header">
                        Estimated Daily Revenue</h5>
                      <div class="card-body">
                        <div id="morris_totalrevenue"></div>
                      </div>
                      <div class="card-footer">
                        <p class="display-7 font-weight-bold">
                          <span class="text-primary d-inline-block">Estimated Revenue Last 30 Days - &pound;{{$estimated_income_last_30}}</span><span class="text-success float-right">+9.45%</span></p>
                      </div>
                    </div>
                </div>
            </div>
                      ...
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                            @foreach($latest_reservations as $reservation)
                              <tr>
                                ...
                                @if($reservation->guests_total > 2)
                                  <td>
                                    <span class="badge-dot badge-success mr-1"></span>Dining Room
                                  </td>
                                @else
                                  <td>
                            ...
                            <tr>
                              <td colspan="9">
                                <a href="/admin/reservations" class="btn bnt-outline-light float-right">View Details</a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
